...
class PvnDetector:
    ...
    def __init__(self, obj_id, n_sample_points):
        ...
        # load custom ops
        ops_base_path = os.path.join(
            SIX_IMPOSE_PATH,'lib/net/pointnet2_utils/tf_ops')
        ...
        model_path = os.path.join(PATH_TO_IMPOSE_GRASP, 'data', 'models', obj_id)
        ...
        # ==================== load_mesh_file ====================
        kps_dir = os.path.join(model_path, "kpoints")
        mesh_path = os.path.join(model_path, "{}.ply".format(obj_id))
